...
let apiKEY = '&appid=8566c3b1fdacf05d0bd69e1615f10652';
...
const getWeatherData = async (base, zip, key, u) => {
  const res = await fetch(base + zip + key + u);
...
// Async function requesting from server to updating the UI
